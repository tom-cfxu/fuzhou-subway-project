...
export const API: API[] = [
  //http请求相关数据
  {
    api: 'carbonTotal',
    comment: '碳排放总览',
    url: `/admin-api/subway/stations/carbon/total${noToken}`,
    type: 'get',
  ...
  },
  {
    api: 'carbonTrendTime',
    comment: '碳排放趋势时间图',
    url: `/admin-api/subway/carbon/emission/trend${noToken}`,
    type: 'post',
  ...
  //mqtt相关数据和控制
  {
    api: 'deviceAll',
    comment: '获取沙盘所有设备信息',
    url: `/app-api/iot/subway/device/all${noToken}`,
    type: 'get',
    header: { 'Content-Type': 'application/x-www-form-urlencoded' }
  },

  {
    ...
    comment: '灯控接口',
    url: `/app-api/iot/subway/device/send/lamp/message${noToken}`,
    type: 'post',
    header: { 'Content-Type': 'application/json' }
  },
  {
    ...
    comment: '空调功率接口',
    url: `/app-api/iot/subway/device/send/airCondition/message${noToken}`,
    type: 'post',
    header: { 'Content-Type': 'application/json' }
  },
  {
    ...
    comment: '能管控制接口',
    url: `/app-api/iot/subway/device/send/emc/message${noToken}`,
    type: 'post',
    header: { 'Content-Type': 'application/json' }
  },
  {
