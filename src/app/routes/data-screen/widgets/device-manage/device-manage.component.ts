...
device_light:any[]=[
  {title:'出入口通道照明-设备1',status:1,stateOject:{1:'开启中',0:'关闭中'},subtitle:'累计碳排放(kg)',value:'26.0',click:(item: any)=>{this.changeLight(item)}},
  {title:'出入口通道照明-设备2',status:0,stateOject:{1:'开启中',0:'关闭中'},subtitle:'累计碳排放(kg)',value:'26.0',click:(item: any)=>{this.changeLight(item)}},
  {title:'站厅照明-设备1',status:1,stateOject:{1:'开启中',0:'关闭中'},subtitle:'累计碳排放(kg)',value:'26.0',click:(item: any)=>{this.changeLight(item)}},
  {title:'站厅照明-设备2',status:1,stateOject:{1:'开启中',0:'关闭中'},subtitle:'累计碳排放(kg)',value:'26.0',click:(item: any)=>{this.changeLight(item)}},
  {title:'站台照明-设备1',status:1,stateOject:{1:'开启中',0:'关闭中'},subtitle:'累计碳排放(kg)',value:'26.0',click:(item: any)=>{this.changeLight(item)}},
  {title:'站台照明-设备2',status:1,stateOject:{1:'开启中',0:'关闭中'},subtitle:'累计碳排放(kg)',value:'26.0',click:(item: any)=>{this.changeLight(item)}},
  {title:'售票区域照明设备',status:1,stateOject:{1:'开启中',0:'关闭中'},subtitle:'累计碳排放(kg)',value:'26.0',click:(item: any)=>{this.changeLight(item)}},
  {title:'检票区域照明设备',status:1,stateOject:{1:'开启中',0:'关闭中'},subtitle:'累计碳排放(kg)',value:'26.0',click:(item: any)=>{this.changeLight(item)}},
];
